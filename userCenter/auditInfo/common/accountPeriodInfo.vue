<template>
	<view class="basic">
		<description-list :title="$t('auditInfo.accountPeriodInfo.basicTle')">
			...
			<description :label="$t('auditInfo.accountPeriodInfo.balanceMoney')">
				{{ info.balanceMoney | toThousandFilter }}</description>
			<description :label="$t('auditInfo.accountPeriodInfo.lastMoney')">{{ info.lastMoney | toThousandFilter }}
			</description>
			<description :label="$t('auditInfo.accountPeriodInfo.effectTime')">{{ info.effectTime | dayjs }}
			</description>
			...
			<description :label="$t('auditInfo.accountPeriodInfo.createTime')">{{ info.createTime | dayjs }}
			</description>
			<description :label="$t('auditInfo.accountPeriodInfo.remarks')">
